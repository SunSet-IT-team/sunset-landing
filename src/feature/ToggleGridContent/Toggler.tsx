...
const Toggler = ({ className, onChange, defaultMode = 'grid' }: TogglerProps) => {
    ...
    return (
        <button
            ...
            className={cn(
                'flex items-center justify-between gap-4 rounded-xl bg-neutral-900/70 text-white p-2 backdrop-blur-sm shadow-inner border border-neutral-700 transition-all duration-300 hover:bg-neutral-800 active:scale-[0.97]',
                className,
            )}>
            {/* Grid icon */}
            <div
